...
<html lang="ar"  dir="rtl">
    ...
    <body>
        ...
        <form name="search" action="viewadmin2.php" method="POST"  onsubmit="return validate()">


            <fieldset id="home"> 
                <h2>عرض بيانات الإنصراف</h2>
                <legend>العرض</legend>

                <h2 style="color: red; display :inline">*</h2>اختر التاريخ المطلوب:

                <?php
                $sql = "SELECT DISTINCT date FROM leave1";
...
// create variables 
        ...
        <?php
        //creat query
        $q2 = "SELECT * FROM leave1 WHERE date='$date' "; 
        //run query
